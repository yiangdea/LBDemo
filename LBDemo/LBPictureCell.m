...
- (instancetype)initWithStyle:(UITableViewCellStyle)style
    ...
    if (self) {
        ...
        self.arrImg = @[_imageLeft, _imageLeft];
        ...
        [self.imageLeft mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.right.mas_equalTo(self.contentView).mas_offset(self.contentView.mas_centerX).mas_offset(-8);
        }];
        ...
        [self.imageRight mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.top.mas_equalTo(self.contentView).mas_offset(8);
            make.bottom.mas_equalTo(self.contentView).mas_offset(-8);
            make.left.mas_equalTo(self.contentView).mas_offset(self.contentView.mas_centerX).mas_offset(8);
        }];
        ...
        [self.imageLeft addGestureRecognizer:tapRight];
    }
    return self;
}
